...
#     "I found that {ratio_top$user} scored the highest with a ratio of {sprintf('%.02f', ratio_top$ratio)}. ",
...
msg <-
  glue::glue(
    "Congratulations @{ratio_top$user} on your ratio of {sprintf('%.02f', ratio_top$ratio)}!"
  )
# msg
# nchar(msg)
